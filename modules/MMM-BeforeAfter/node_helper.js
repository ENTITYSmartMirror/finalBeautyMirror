    ...
    switch(notification) {
      case "BEFORECAPTURE":
        console.log("notification : " + notification)
	      PythonShell.run('/home/pi/Desktop/BeautyMirror/modules/MMM-BeforeAfter/before.py', null, function (err, result) {
            if (err) throw err;
            console.log(result);          
      ...
      case "AFTERCAPTURE":
        console.log("notification : " + notification)
        PythonShell.run('/home/pi/Desktop/BeautyMirror/modules/MMM-BeforeAfter/before2.py', null, function (err, result) {
          if (err) throw err;
          console.log(result);          
